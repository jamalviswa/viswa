    ...
    <div class="block-header">
        <div class="row clearfix">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                ...
                <a href="{{ url('admin/products/add') }}" class="btn btn-sm btn-primary" title="">Create New</a>
            </div>
        </div>
    </div>
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
                                            ...
                                            <a href="{{ url('admin/products/index') }}" class="btn btn-danger"><i class="icon-close"></i></a>
                                ...
                                <table class="table table-hover m-b-0 c_list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="c_name">Bookit</p>
                                            </td>
                                            <td>
                                                <p class="c_name">App Development</p>
                                            </td>
                                            <td>
                                                <p>https://viswatechnologysolutions.com/</p>
                                            </td>
                                            <td>
                                                <img src="{{URL::to('images/blogs/olympic.jpg')}}" class="avatar" alt="VTS" width="100" height="50">
                                            </td>
                                            <td>
                                                <a href="{{ url('admin/products/edit') }}" class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i></a>
