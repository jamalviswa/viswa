                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-3 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            ...
                            <a class="text-light mb-2" href="{{ url('about') }}"><i class="bi bi-arrow-right text-primary me-2"></i>About</a>
                            <a class="text-light mb-2" href="{{ url('services') }}"><i class="bi bi-arrow-right text-primary me-2"></i>Services</a>
                            <a class="text-light mb-2" href="{{ url('blogs') }}"><i class="bi bi-arrow-right text-primary me-2"></i>Blogs</a>
                            <a class="text-light mb-2" href="{{ url('videos') }}"><i class="bi bi-arrow-right text-primary me-2"></i>Videos</a>
                            <a class="text-light mb-2" href="{{ url('portfolio') }}"><i class="bi bi-arrow-right text-primary me-2"></i>Portfolio</a>
                    ...
                    <div class="col-lg-5 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <p class="mb-0">83A,Ramalingam Colony,Saibaba Colony,Coimbatore</p>
                        </div>
                        <div class="d-flex mb-4">
