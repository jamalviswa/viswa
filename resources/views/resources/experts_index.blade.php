    ...
    <div class="block-header">
        <div class="row clearfix">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                ...
                <a href="{{ route('resources.experts_add') }}" class="btn btn-sm btn-primary">Create New</a>
            </div>
        </div>
    </div>
                                ...
                                <form method="GET" action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
                                            ...
                                            <a href="{{ route('resources.experts_index') }}" class="btn btn-danger"><i class="icon-close"></i></a>
                                            @endif
                                        </div>
                                    </div>
                                </form>
                                ...
                                <table class="table table-hover m-b-0 c_list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{URL::to('images/experts/'.$expert['image'].'')}}" target="_blank">
